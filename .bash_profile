...
alias letsplay='start_dev_env'

# B2C configurations (Java)
export MAVEN_HOME=/Users/${USER}/Development/apache-maven-3.0.5
...
# Run process for init java dev
alias b2c_build='cd /Users/${USER}/projects/wine/wine/bigw; pwd; mvn clean install -DskipAllTests -T 4;cd /Users/${USER}/projects/wine/wine/extensions; pwd; mvn clean install -Dmaven.test.skip=true -DskipAllTests -T 4'
...
#WS PICASSO ROXO  #
######################
export AWS_ACCESS_KEY_ID="AKIAJMQV4PX7YKKIPQMQ"
export SECRET_ACCESS_KEY="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"
